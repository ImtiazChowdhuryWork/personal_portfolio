...
func (s *ProfileService) Update(updates *models.Profile) (*models.Profile, error) {
	...
	updates.AboutTitle      = preserve(updates.AboutTitle, profile.AboutTitle)
	updates.AboutParagraph2 = preserve(updates.AboutParagraph2, profile.AboutParagraph2)
	updates.Focus           = preserve(updates.Focus, profile.Focus)
	...
	updates.TechMastered    = preserve(updates.TechMastered, profile.TechMastered)
	updates.YearsExperienceLabel = preserve(updates.YearsExperienceLabel, profile.YearsExperienceLabel)
	updates.AppsShippedLabel     = preserve(updates.AppsShippedLabel,     profile.AppsShippedLabel)
	updates.TechMasteredLabel    = preserve(updates.TechMasteredLabel,    profile.TechMasteredLabel)
